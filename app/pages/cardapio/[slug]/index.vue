...
const { buscarRestaurantePorSlug, buscarCategorias, buscarProdutos } = useCardapioPublico()
...
// Categorias visíveis (filtradas por pesquisa e categoria selecionada)
...
const restauranteAberto = computed(() => {
  // TODO: Implementar lógica real de horário de funcionamento
  return restaurante.value?.cardapio_ativo || false
})

// Texto do horário
const horarioTexto = computed(() => {
  // TODO: Formatar horário real
  return '06:00 às 06:01'
})
