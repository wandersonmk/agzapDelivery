...
<template>
  ...
  <button
    ...
    class="fixed bottom-4 left-4 right-4 md:bottom-6 md:right-6 md:left-auto z-40 bg-orange-500 hover:bg-orange-600 text-white rounded-full md:rounded-full shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 flex items-center justify-between md:justify-start gap-3 px-4 py-3 md:px-6 md:py-4 group"
  >
    <!-- Ícone e Badge -->
    <div class="relative">
